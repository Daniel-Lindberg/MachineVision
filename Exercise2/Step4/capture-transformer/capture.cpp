...
static void process_image(const void *p, int size, int option)
{
...
static int read_frame(int option)
{
    ...
    switch (io)
    {
        ...
        case IO_METHOD_READ:
            ...
            process_image(buffers[0].start, buffers[0].length, option);
            break;
        ...
        case IO_METHOD_MMAP:
            ...
            process_image(buffers[buf.index].start, buf.bytesused, option);
        ...
        case IO_METHOD_USERPTR:
            ...
            process_image((void *)buf.m.userptr, buf.bytesused, option);
...
static void mainloop(void)
{
    ...
    while (count > 0)
    {
	    ...
	    //fprintf(stderr,"%c",c);
            ...
            if(c == 'c' || c=='C')
            {
                printf("display canny\n");
                option = 1;
            }
            if(c== 's' || c== 'S'){
                printf("display sobel\n");
                option = 2;
            }


            if (read_frame(option))
            {
