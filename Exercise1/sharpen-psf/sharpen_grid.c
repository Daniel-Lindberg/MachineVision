...
int main(int argc, char *argv[])
{
    ...
    for(thread_idx=0; thread_idx<(NUM_ROW_THREADS*NUM_COL_THREADS); thread_idx++)
    {
        ...
        if(thread_idx == 8) {idx=(1*(IMG_H_SLICE-1)); jdx=(thread_idx*(IMG_W_SLICE-1));}
        if(thread_idx == 9) {idx=(1*(IMG_H_SLICE-1)); jdx=(thread_idx*(IMG_W_SLICE-1));}
        if(thread_idx == 10) {idx=(1*(IMG_H_SLICE-1)); jdx=(thread_idx*(IMG_W_SLICE-1));}
        if(thread_idx == 11) {idx=(1*(IMG_H_SLICE-1)); jdx=(thread_idx*(IMG_W_SLICE-1));}
